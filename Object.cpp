...
void Object::load(const std::string filename, const bool autoCentre = false, const bool autoNormalize = false) {
...
Vector3* Object::getIndexedPositions() {
	return this->indexedPositions.data();
}

Vector2* Object::getIndexedTextureCoords() {
	return this->indexedTextureCoords.data();
}

Vector3* Object::getIndexedNormals() {
	return this->indexedNormals.data();
}

unsigned int Object::getNumTriangles() {
	return this->numTriangles;
}

unsigned int Object::getNumIndexedVertices() {
	return this->numIndexedVertices;
}

unsigned int* Object::getTriangleIndices() {
